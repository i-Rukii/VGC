...
export default function Home() {
  ...
  const renderTab = () => {
    switch (activeTab) {
      ...
      case 'meta-trends': return <MetaTrends />;
      case 'tournaments': return <TournamentTracker />;
    }
  };

  return (
    <div className="flex min-h-screen" style={{ background: '#121212', fontFamily: "'DM Mono', 'JetBrains Mono', 'Fira Code', monospace" }}>
      {/* Sidebar */}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top bar */}
        <header className="h-12 border-b border-[#2d2d2d] flex items-center px-8 gap-3 flex-shrink-0"
          style={{ background: '#0e0e0e' }}>
          <div className="flex items-center gap-2">
            <div className="w-1 h-4 rounded-full bg-orange-500" style={{ boxShadow: '0 0 8px rgba(249,115,22,0.6)' }} />
